    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">TourLingo</h1>
          <p className="text-gray-600 mt-1">Operator Dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full mt-4 py-2 px-4 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Need an account?{' '}
          <a href="mailto:support@tourlingo.app" className="text-blue-600 hover:text-blue-700">
            Contact us
          </a>
        </p>
      </div>
